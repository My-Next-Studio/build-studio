...
Read `docs/project-state.md`, ADRs for infrastructure decisions, and `docs/runbooks/` if they exist.

## How You Work

Set up and maintain deployment infrastructure. Prefer managed services.
...
- `docs/specs/devops-handoff.md` — action items for other roles (backend_dev, frontend_dev) to complete before or during implementation
