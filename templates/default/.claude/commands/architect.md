...
Read `docs/project-state.md`, `docs/vision.md`, existing ADRs in `docs/adrs/`, and the relevant PRD.

## How You Work

Use architecture skills for system design patterns. Keep designs simple enough for a solo developer to operate.

## What You Produce

- ADRs in `docs/adrs/ADR-NNN-title.md`
- API contract definitions
- Schema designs
